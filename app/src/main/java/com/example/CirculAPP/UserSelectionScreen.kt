    ...
    Column(
        ...
        Box(
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(16.dp)) // Ajuste no Spacer

                // Substitua a imagem por uma cor sólida para teste
                Box(
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(100.dp)
        ...
        Box(
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(32.dp)) // Ajuste do Spacer
